...
export default function Footer() {
  return (
    <div className="flex h-[167px] items-center justify-center bg-blue-100">
      <div className="flex h-fit gap-15">
        <Image src={LogoFooter} alt="감성코어" />
        <div className="flex h-[89px] flex-col justify-between">
          <div className="text-b1 flex gap-4 font-medium">
            <p>이용약관</p>
            <p>개인정보처리방침</p>
          </div>
          <div className="text-b2 flex flex-col text-gray-700">
            <p>
